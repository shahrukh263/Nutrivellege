        ...
        <div className="border-b border-b-[#F0F0F0]">
          <div className="innerDiv mx-auto">
            <ul className="flex sm:gap-x-12 gap-x-6">
              <li>
                <a className="sm:text-[26px] text-[16px] sm:font-[700] font-[500] text-[#3A3A3A] border-b-[3px] border-b-[#27874E] block">Sign Up</a>
              </li>
              <li>
          ...
          <div className="innerDiv mx-auto">
            <div className="flex flex-wrap sm:-mx-3">
              <div className="xl:w-1/2 lg:w-7/12 sm:px-3 w-full">
                <ul>
                  <li className="bg-[#F8FAF7] rounded-[16px] border border-[rgba(166,166,170,.6)] md:py-[75px] py-[50px] xl:px-[90px] lg:px-[60px] md:px-[50px] px-[20px]">
                    <h1 className="text-[29px] font-[700] text-black">Already have an account?</h1>
                    <p className="text-[#444150] mb-12">
                      Already have an account? <Link href={'/login'} passHref><a className="text-[#27874E] font-[500] underline">Log in</a></Link>
                    </p>
                    <div className="mb-6">
                    ...
                    <div className="mb-6">
                      <label className="block text-[#444150] font-[500] text-base mb-2">
                        Password<span className="text-[#27874E]">*</span> <i className="fa-regular fa-circle-question"></i>
                      </label>
                      ...
                      className="text-[#444150] text-[20px] absolute right-[10px] top-[12px] cursor-pointer">
                        <i className={showPassword ? "fa-sharp fa-solid fa-eye-slash":"fa-regular fa-eye"}></i></a>                      </div>
                    </div>
                    <div className="mb-9">
                      <label className="block text-[#444150] font-[500] text-base mb-2">
                        Confirm Password<span className="text-[#27874E]">*</span>
                      </label>
                      <input type="password" className="block w-full border border-[#D9D9D9] py-[14px] px-4 rounded-[6px] outline-none" placeholder="Enter Password" />
                    </div>
                    <div className="mb-9">
                      <input type="submit" className="block w-full text-[18px] font-[700] shadow-[0px_12px_21px_4px_rgba(68,97,242,0.15)] py-[14px] bg-[#27874E] px-4 rounded-[10px] text-white outline-none" value={'Sign Up'} />
                    </div>
