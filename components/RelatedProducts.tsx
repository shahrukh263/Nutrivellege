...
const RelatedProducts: NextComponentType = () => {
  return (
    <>
      <section className="sm:py-[50px] py-[30px]">
        <div className="title border-b border-b-[#F0F0F0] mb-4">
          <div className="innerDiv mx-auto">
            <h3 className="text-[26px] font-[700] border-b-[3px] border-b-[#27874E] inline-block">Related Product</h3>
          </div>
        </div>
        <div className="innerDiv mx-auto">
          <div className="flex flex-wrap justify-between sm:-mx-3 mt-[100px]">
            ...
            <div className="sm:px-3 lg:w-[30%] md:w-1/2 sm:w-1/2 w-full">
              <div className="bg-white relative sm:mb-[100px] mb-[40px] rounded-[26px] shadow-[0px_2px_8px_rgba(0,0,0,0.1)] py-[25px] sm:px-[30px] px-[20px]">
                <div className="mt-[-100px]">
                  <Image src={Product1} alt="" />
                </div>
                <div className=" absolute right-[20px] top-[30px]">
